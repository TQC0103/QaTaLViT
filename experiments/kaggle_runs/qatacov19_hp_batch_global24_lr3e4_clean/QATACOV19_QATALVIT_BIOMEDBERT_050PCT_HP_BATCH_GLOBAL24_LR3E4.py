# Auto-exported from QATACOV19_QATALVIT_BIOMEDBERT_050PCT_HP_BATCH_GLOBAL24_LR3E4.ipynb
...
class CFG:
    ...
    image_size: int = 224
    epochs: int = 60
    model_name: str = "QaTaLViT-BiomedBERT-HP-BatchGlobal24-LR3e4"
    ...
    epi_beta: float = 0.99
    unlabeled_batch_size_per_gpu: int = 12
    ...
    save_dir: str = "/kaggle/working/qata_lvit_biomedbert_50pct_hp_batch_global24_lr3e4_runs"
...
for epoch in range(start_epoch, cfg.epochs + 1):
    ...
    print(
        ...
        f"student={_fmt_metric(row['val_dice_student'])} | ema={_fmt_metric(row['val_dice_ema'])}"
    )
    print(
...
_run_notebook_shell('python qata_lvit_biomedbert_hp_batch_global24_lr3e4.py')
