"""Core baseline LViT architecture used as the reference model.

The file contains the encoder, cross-modal transformer blocks, and the
decoder that reconstructs the final segmentation mask.
"""
