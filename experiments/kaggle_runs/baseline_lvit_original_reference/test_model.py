"""Evaluate a saved baseline LViT checkpoint on the selected test split."""
...
def show_image_with_dice(predict_save, labs, save_path):
    """Save one predicted mask and compute Dice/IoU against the ground truth."""
...
def vis_and_save_heatmap(model, input_img, text, img_RGB, labs, vis_save_path, dice_pred, dice_ens):
    """Run inference for one sample and export the predicted mask image."""
    model.eval()
...
"""Evaluation script for the baseline LViT model.

The script loads a trained checkpoint, runs inference on the evaluation split,
and reports the segmentation metrics used in the report.
"""
