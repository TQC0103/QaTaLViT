# Auto-exported from QATACOV19_QATALVIT_BIOMEDBERT_050PCT_HP_GLOBALBS16_LR3E4.ipynb
...
class CFG:
    ...
    image_size: int = 224
    epochs: int = 60
    model_name: str = "QaTaLViT-BiomedBERT-HP-GlobalBS16-LR3e4"
    ...
    save_dir: str = "/kaggle/working/qata_lvit_biomedbert_50pct_hp_globalbs16_lr3e4_runs"
...
_run_notebook_shell('python qata_lvit_biomedbert_hp_globalbs16_lr3e4.py')
