...
`QATACOV19_QATALVIT_BIOMEDBERT_050PCT_HP_GLOBALBS16_LR3E4.ipynb`

## Python source

`QATACOV19_QATALVIT_BIOMEDBERT_050PCT_HP_GLOBALBS16_LR3E4.py`

## Dùng trong report

Hyperparameter ablation: effective batch size 16, lr = 3e-4.

## Kết quả / vai trò

QaTa-COV19 50% HP row: 83.63 / 75.18
