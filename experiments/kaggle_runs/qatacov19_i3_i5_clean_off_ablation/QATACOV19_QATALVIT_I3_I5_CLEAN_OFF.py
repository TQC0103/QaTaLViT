# Auto-exported from QATACOV19_QATALVIT_I3_I5_CLEAN_OFF.ipynb
...
# %% markdown cell 0
# # QaTa-Covid19 Language-guided Vision Transformer (Kaggle-ready, clean I3/I5 off)
#
...
# - language features are fused with a clean 1-stage LV ablation,
# - the loss keeps Dice, BCE, and Focal Tversky while disabling image-text alignment,
...
class CFG:
    ...
    num_lv_fusion_stages: int = 1
    use_i4_focal_tversky: bool = True
    use_i5_alignment_full: bool = False
    ...
    save_dir: str = "/kaggle/working/qata_lvit_i3_i5_clean_off_runs"
