# Auto-exported from MOSMED_QATALVIT_BIOMEDBERT_050PCT_STUDENTONLY_LOSSCLEANUP_CROPONLY.ipynb
...
class CFG:
    ...
    epochs: int = 120
    model_name: str = "MosMedLViT-BiomedBERT-StudentOnlyLossCleanup"
    ...
    save_dir: str = "/kaggle/working/mosmed_lvit_biomedbert_50pct_studentonly_losscleanup_croponly_runs"
...
_run_notebook_shell('python mosmed_lvit_biomedbert_studentonly_losscleanup_croponly.py')
