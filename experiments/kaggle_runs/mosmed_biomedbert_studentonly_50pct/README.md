...
`MOSMED_QATALVIT_BIOMEDBERT_050PCT_STUDENTONLY_LOSSCLEANUP_CROPONLY.ipynb`

## Python source

`MOSMED_QATALVIT_BIOMEDBERT_050PCT_STUDENTONLY_LOSSCLEANUP_CROPONLY.py`

## Dùng trong report

MosMedData+ BiomedBERT student-only, loss cleanup, crop-only.

## Kết quả / vai trò

MosMedData+ 50%: 72.85 / 59.41
