...
`MOSMED_QATALVIT_NOBERT_050PCT_STUDENTONLY_LOSSCLEANUP_CROPONLY.ipynb`

## Python source

`MOSMED_QATALVIT_NOBERT_050PCT_STUDENTONLY_LOSSCLEANUP_CROPONLY.py`

## Dùng trong report

MosMedData+ NoBERT student-only, crop-only/loss-cleanup; dùng trong ablation chọn ngưỡng validation.

## Kết quả / vai trò

MosMedData+ NoBERT validation-threshold row: 72.69 / 58.99
