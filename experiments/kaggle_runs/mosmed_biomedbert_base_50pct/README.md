...
`MOSMED_QATALVIT_BIOMEDBERT_050PCT_688_BASE_FIXED_EPI.ipynb`

## Python source

`MOSMED_QATALVIT_BIOMEDBERT_050PCT_688_BASE_FIXED_EPI.py`

## Dùng trong report

MosMedData+ BiomedBERT ban đầu, còn bật pseudo/EMA/EPI.

## Kết quả / vai trò

MosMedData+ 50%: 68.88 / 55.14
