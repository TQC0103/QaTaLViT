# Auto-exported from QATACOV19_QATALVIT_BIOMEDBERT_050PCT_HP_BATCH_GLOBAL16_LR3E4.ipynb
...
class CFG:
    ...
    image_size: int = 224
    epochs: int = 60
    model_name: str = "QaTaLViT-BiomedBERT-HP-BatchGlobal16-LR3e4"
    ...
    epi_beta: float = 0.99
    unlabeled_batch_size_per_gpu: int = 8
    ...
    save_dir: str = "/kaggle/working/qata_lvit_biomedbert_50pct_hp_batch_global16_lr3e4_runs"
...
_run_notebook_shell('python qata_lvit_biomedbert_hp_batch_global16_lr3e4.py')
