...
`QATACOV19_QATALVIT_BIOMEDBERT_050PCT_HP_BATCH_GLOBAL16_LR3E4.ipynb`

## Python source

`QATACOV19_QATALVIT_BIOMEDBERT_050PCT_HP_BATCH_GLOBAL16_LR3E4.py`

## Dùng trong report

Notebook clean cho ablation batch size với effective global batch 16, lr 3e-4.

## Kết quả / vai trò

QaTa-COV19 50% batch-size ablation: 83.63 / 75.18.
