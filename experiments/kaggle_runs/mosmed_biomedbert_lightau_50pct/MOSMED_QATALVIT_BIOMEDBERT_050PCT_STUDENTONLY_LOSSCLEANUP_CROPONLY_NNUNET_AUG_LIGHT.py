# Auto-exported from MOSMED_QATALVIT_BIOMEDBERT_050PCT_STUDENTONLY_LOSSCLEANUP_CROPONLY_NNUNET_AUG_LIGHT.ipynb
...
_run_notebook_shell('python mosmed_lvit_biomedbert_studentonly_losscleanup_croponly_nnunet_aug_light.py')
