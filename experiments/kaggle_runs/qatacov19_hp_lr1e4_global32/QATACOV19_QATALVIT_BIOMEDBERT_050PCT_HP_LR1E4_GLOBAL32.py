# Auto-exported from QATACOV19_QATALVIT_BIOMEDBERT_050PCT_HP_LR1E4_GLOBAL32.ipynb
...
class CFG:
    ...
    image_size: int = 224
    epochs: int = 60
    model_name: str = "QaTaLViT-BiomedBERT-HP-LR1e4-Global32"
    ...
    save_dir: str = "/kaggle/working/qata_lvit_biomedbert_50pct_hp_lr1e4_global32_runs"
...
_run_notebook_shell('python qata_lvit_biomedbert_hp_lr1e4_global32.py')
