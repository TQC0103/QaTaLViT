# Auto-exported from QATACOV19_QATALVIT_BIOMEDBERT_050PCT_RERUN_EPI099.ipynb
...
class CFG:
    ...
    save_dir: str = "/kaggle/working/qata_lvit_biomedbert_50pct_rerun_epi099_runs"
...
_run_notebook_shell('python qata_lvit_biomedbert_rerun_epi099.py')
