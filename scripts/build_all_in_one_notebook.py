...
DIST_DIR = ROOT / "dist"
NOTEBOOK_PATH = ROOT / "notebooks" / "KAGGLE_QATACOV19_ALL_IN_ONE.ipynb"
...
def build_notebook() -> dict:
    text_encoder_source = read_source("src/text_encoder.py")
    dataset_source = read_source("src/Load_Dataset.py")
    improved_ssl_source = read_source("src/nets/improved_ssl.py")
    improved_model_source = read_source("src/nets/LViT_improved.py")
    improved_training_source = read_source("src/nets/improved_training.py")
    train_script_source = read_source("src/train_improved_ssl.py")
