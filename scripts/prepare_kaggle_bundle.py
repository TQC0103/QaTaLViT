...
FILES_TO_COPY = [
    ".gitignore",
    "docs/KAGGLE_TRAIN.md",
    "docs/KAGGLE_NOTEBOOK_CELLS.md",
    "requirements-kaggle.txt",
    "src/Load_Dataset.py",
    "src/text_encoder.py",
    "src/utils.py",
    "src/train_improved_ssl.py",
    "scripts/run_qatacov19_benchmark.py",
    "scripts/run_qatacov19_100pct.py",
    "scripts/run_qatacov19_050pct.py",
    "scripts/run_qatacov19_025pct.py",
    "src/nets/__init__.py",
    "src/nets/LViT_improved.py",
    "src/nets/improved_ssl.py",
    "src/nets/improved_training.py",
]
